...
namespace EFCorePeliculasApi.Migrations
{
    ...
    public partial class datosDePrueba : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "CinesOfertas",
                columns: new[] { "Id", "CineId", "FechaFinal", "FechaInicio", "PorcentajeDescuento" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 4, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 4, 27, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2024, 5, 2, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 4, 27, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
