...
namespace EFCorePeliculasApi.Entidades.Seeding
{
	public static class SeedingModuloConsulta
	{
        ...
        {
			/*
             esto se utiliza para tener datos por defecto en la bd
             */
			//aca creamos el objeto que deseamos agregar con su respectiva clase
			...
			//aca se cargan al entity correspondiente por medio de hasdata
			...
			var agoraCineOferta = new CineOferta { Id = 1, CineId = agora.Id, FechaInicio = DateTime.Today, FechaFinal = DateTime.Today.AddDays(7), PorcentajeDescuento = 10 };
			...
			var salaDeCineCXCMegacentro = new SalaDeCine()
			{
				...
				CineId = megacentro.Id,
				Precio = 450,
				TipoSalaDeCine = TiposSalaDeCine.CXC
			};
			...
			var acropolisCineOferta = new CineOferta { Id = 2, CineId = acropolis.Id, FechaInicio = DateTime.Today, FechaFinal = DateTime.Today.AddDays(5), PorcentajeDescuento = 15 };
